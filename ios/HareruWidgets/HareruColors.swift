...
extension Color {
    ...
    // Tinted card backgrounds (12% opacity tint)
    static let expenseTint = Color(red: 1.0, green: 0.32, blue: 0.32).opacity(0.12)
    static let transferTint = Color(red: 0.27, green: 0.54, blue: 1.0).opacity(0.12)
    static let savingTint = Color(red: 0.30, green: 0.69, blue: 0.31).opacity(0.12)
    static let incomeTint = Color(red: 0.49, green: 0.30, blue: 1.0).opacity(0.12)
