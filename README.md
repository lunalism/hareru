...
> 銀行間の振替が「支出」としてカウントされ、家計簿のデータが汚染されています。
> 既存アプリでは、本当にいくら使ったのかが見えません。

**This is not a minor inconvenience.** In a survey of 193 users who quit budgeting apps, 29.7% said the top reason was *"I couldn't feel any actual savings"* — because the data they were looking at was never accurate in the first place.
